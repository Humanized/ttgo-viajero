...
return [
    ...
    'Delete' => 'Supprimer',
    'Error' => 'Erreur',
    'File upload failed.' => 'Le fichier n\'a pas pu être uploadé.',
    'Home' => 'Accueil',
    'Invalid data received for parameter "{param}".' => 'Donnée incorrect pour le paramètre "{param}".',
    'Login Required' => 'Connection requise',
    'Missing required arguments: {params}' => 'Arguments requis manquants: {params}',
    'Missing required parameters: {params}' => 'Paramètres requis manquants: {params}',
    'No' => 'Non',
    'No results found.' => 'Aucun résultat trouvé',
    'Only files with these MIME types are allowed: {mimeTypes}.' => 'Les types de fichier suivantes sont authorisés: {mimeTypes}.',
    'Only files with these extensions are allowed: {extensions}.' => 'Les extensions de fichier suivantes sont authorisées: {extensions}.',
    'Page not found.' => 'Page introuvable.',
    'Please fix the following errors:' => 'Veuillez résoudre les erreurs suivantes:',
    'Please upload a file.' => 'Veuiller uploader un fichier.',
    'Showing <b>{begin, number}-{end, number}</b> of <b>{totalCount, number}</b> {totalCount, plural, one{item} other{items}}.' => '<b>{begin, number}-{end, number}</b> sur <b>{totalCount, number} {totalCount, plural, one{élément} other{élements}} </b>.',
    'The combination {values} of {attributes} has already been taken.' => 'La combinaison {values} de {attributes} a déjà été prise',
    'The file "{file}" is not an image.' => 'Le fichier "{file}" n\'est pas une image.',
    'The file "{file}" is too big. Its size cannot exceed {formattedLimit}.' => 'Le fichier "{file}" est trop grand. Sa taille ne peut excéder {formmattedLimit}.',
];
